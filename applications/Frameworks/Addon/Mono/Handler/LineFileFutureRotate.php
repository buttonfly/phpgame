<?php
class Mono_Handler_LineFileFutureRotate extends Mono_Handler_Abstract {
    ...
    protected function write(array $record)
    {
        if (null === $this->stream) {
            ...
            $future_time = intval((time()+$this->interval)/$this->interval) * $this->interval;
            $filename = date('YmdHis', $future_time);
